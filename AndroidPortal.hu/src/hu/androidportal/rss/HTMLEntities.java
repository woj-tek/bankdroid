...
public class HTMLEntities
{
	 ...
	 */
	private static final Map<Integer, String> htmlEntitiesMap = new HashMap<Integer, String>();

	/**
	 * Map to convert html entities in exteden characters.
	 */
	private static final Map<String, Integer> unhtmlEntitiesMap = new HashMap<String, Integer>();
	...
	private static void initializeEntitiesTables()
	{
		...
		{
			htmlEntitiesMap.put((Integer) HTML_ENTITIES_TABLE[i][1], (String) HTML_ENTITIES_TABLE[i][0]);
			unhtmlEntitiesMap.put((String) HTML_ENTITIES_TABLE[i][0], (Integer) HTML_ENTITIES_TABLE[i][1]);
		}
	}
	 ...
	 * @see #fromHtmlEntities(String)
	 */
	public static String toHtmlEntities( final String str )
	{
		...
		final StringBuilder buf = new StringBuilder(); //the otput string buffer

		final int length = str.length();
		for ( int i = 0; i < length; ++i )
		{
			final char ch = str.charAt(i);
			final String entity = htmlEntitiesMap.get(new Integer(ch)); //get equivalent html entity
			if ( entity == null )
